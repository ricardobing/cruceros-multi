      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <div className="card p-8">
            <div className="flex items-center gap-2 text-ocean-blue mb-4">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <span className="font-semibold">{excursion.destination.name}</span>
            </div>

            <h1 className="text-4xl font-bold text-gray-900 mb-6">{excursion.title}</h1>
        ...
        <div>
          <div className="card p-6 sticky top-4">
            <h2 className="text-2xl font-semibold mb-4">{t('availableDates')}</h2>
            <DeparturesList
              departures={excursion.departures}
              locale={locale}
            />
          </div>
        </div>
